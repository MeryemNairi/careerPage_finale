...
const Parrainage: React.FC = () => {
    const handleClick1 = (): void => {
        window.location.href = 'https://cnexia.sharepoint.com/sites/CnexiaForEveryone/SitePages/ParrainageV2.aspx';
    };
    return (
            ...
            <div className={styles.banner}>
                <div className={styles.banner_content}>
                    <div className={styles.banner_text}>
                        <p>
                        Parrainez et devenez <br /><span style={{fontWeight:'700'}}>ambassadeur de Cnexia </span>
                        
                        </p>
                    </div>
                    <button className={styles.banner_button} onClick={handleClick1}>
